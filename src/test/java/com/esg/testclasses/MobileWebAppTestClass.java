...
public class MobileWebAppTestClass extends HelperClass {
	...
	public static void OpenWebURL() {
		...
		test.log(LogStatus.INFO, "This Script is running against the version - https://esg-eecp-qa2.directapps.int/50.0/m/rebates/AMWA/AMWAM1");
		threadWait(5000);
	...
	public static void ProgramEligibiltyError(){
		...
		threadWait(2500);
		WaitForElement(2500, "MobileWebApp", "NextButton");
		clickWebelement("MobileWebApp", "NextButton");
		//threadWait(2500);
		WaitForElement(2500, "MobileWebApp", "AcceptButton");
		clickWebelement("MobileWebApp", "AcceptButton");
		//threadWait(2500);
		WaitForElement(2500, "MobileWebApp", "NextButton");
		clickWebelement("MobileWebApp", "NextButton");
		//threadWait(2500);
		WaitForElement(2500, "MobileWebApp", "AccountName");
		...
		WaitForElement(2500, "MobileWebApp", "RebateNumber");
		...
		WaitForElement(2500, "MobileWebApp", "EnrollmentList");
		//threadWait(5000);
		clickWebelement("MobileWebApp", "EnrollmentList");
		//threadWait(2500);
		WaitForElement(2500, "MobileWebApp", "ApplicationStatus");
	...
	public static void MeasureEligibilityError() {
		openURL("MobileWebApp", "WebURL");
		//threadWait(5000);
		WaitForElement(2500, "MobileWebApp", "Make");
	...
	public static void AccountValidationError() {
		...
		WaitForElement(2500, "MobileWebApp", "NextButton");
		clickWebelement("MobileWebApp", "NextButton");
		WaitForElement(2500, "MobileWebApp", "LookUp");
